...
public class ExtensionLoader<T> {
     ...
     */
    private static final String DEFAULT_DIRECTORY = "META-INF/fusion-center/";
    ...
    public T getDefaultJoin() {
        getExtensionClasses();
        if (StrUtil.isNotBlank(cacheDefaultName)) {
    ...
    public T getJoin(String cacheDefaultName) {
        // 扩展名 文件中的key
        if (StrUtil.isBlank(cacheDefaultName)) {
    ...
    private void loadResources(Map<String, Class<?>> classes, URL url) {
        ...
        try (InputStream inputStream = url.openStream()) {
            ...
            properties.forEach((k, v) -> {
                ...
                if (StrUtil.isNotBlank(name) && StrUtil.isNotBlank(classPath)) {
                    try {
